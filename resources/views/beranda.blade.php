...
<div class="container mx-auto">
    {{-- HERO --}}
    <section>
        <div class="px-4 py-18 mx-auto max-w-7xl sm:px-6 md:px-12 lg:px-24 lg:py-10">
            <div class="flex flex-wrap items-center mx-auto max-w-7xl">
                ...
                <div
                    ...
                    <span class="mb-8 text-xs font-bold tracking-widest text-blue-600 uppercase"> IKHLAS BERAMAL </span>
                    <h1
        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="py-4 px-6">
                        <form action="/mahasiswa/{{ $mahasiswas->id }}/delete" method="POST">
                            <a href="/mahasiswa/{{$mahasiswas->id}}/edit"
