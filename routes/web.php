...
Route::get('/mahasiswa/{id}/edit', [App\Htttp\Controllers\MahasiswaController::class, 'editData']); 
Route::delete('/mahasiswa/{id}/delete', [App\Http\Controllers\MahasiswaController::class, 'deleteData']); 
Route::post('/mahasiswa/{id}/edit', [App\Http\Controllers\MahasiswaController::class, 'formEdit']);
